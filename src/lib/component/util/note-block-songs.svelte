...
<table class="w-[90%] lg:w-[60%] text-white mt-12">
    <tr class="bg-[#1d1f24] rounded-lg">
        <th class="p-2 pl-6 font-medium text-[20px] text-left flex rounded-tl-lg rounded-lg">
            <p>Title</p>
            <a aria-label='Download All Songs' href="https://api.github.com/repos/flytegg/nbs-songs/zipball/master" download="https://api.github.com/repos/flytegg/nbs-songs/zipball/master" class="ml-auto">
        ...
        <tr class="">
            ...
            <td class=" self-center mt-1 justify-center items-center">
                <a aria-label='Download Song' download={song.downloadUrl} href="{song.downloadUrl}">
                    <button on:click={downloadSuccess} class="pl-4">
