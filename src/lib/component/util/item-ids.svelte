...
<input class="search w-[26rem]" on:keypress={handleKeyPress} on:blur={handleInput} bind:value={searchValue} on:input={handleInput} type="text" placeholder="Enter item name...">
