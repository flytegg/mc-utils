const utils: Util[] = [
    {
        ...
        seoDescription: "Download Minecraft server jars of any version including Vanilla, Fabric, CraftBukkit, Spigot, Paper, Purpur, Folia, BungeeCord, Waterfall and Velocity."
    },
    {
        path: "item-ids",
        name: "Item IDs",
        ...
        seoDescription: "An interactive list of all Minecraft item IDs, including current and legacy IDs (data values)."
    },
    {
        ...
        seoDescription: "A minimal script generator to produce start.bat or start.command files for Minecraft Spigot/Paper servers with customisable RAM and Flags (proxy & Aikar's flags)."
    },
    {
        path: "server-info",
        name: "Server Info",
        ...
        seoDescription: "A Minecraft server list like viewer to view live player counts, MOTD and favicon."
    }, {
        path: "inventory-slots",
        name: "Inventory Slots",
        description: "Slot numbers for every inventory type.",
        shortDescription: "Numbers for all inventories",
        seoDescription: "A list of Minecraft Bukkit inventory slot IDs including chests, double chests, furnace, player, villager, brewing stand, crafting table and many more."
    }, {
        path: "skin-stealer",
        name: "Skin Stealer",
        description: "Steal a player's skin from their IGN.",
        shortDescription: "Steal another player's skin",
        seoDescription: "View and download any Minecraft player's skin by searching their in-game name."
    }, {
        path: "color-codes",
        name: "Color Codes",
        description: "List of built in color and format codes.",
        shortDescription: "All default color codes",
        seoDescription: "Table of Minecraft color codes along with the chat code (&), the MiniMessage tag, the MOTD code and the hex codes."
    }, {
        ...
        seoDescription: "Generate text using Minecraft color codes & custom hex codes and preview as text, in sign, a book, chat and MOTD."
    }, {
        path: "gradient-generator",
        name: "Gradient Generator",
        description: "Create a gradient between two colors for in-game text.",
        shortDescription: "Create chat color gradient",
        seoDescription: "Create a custom gradient between two colors and receive Spigot ChatColor and MiniMessage output for use in Minecraft plugins."
    }, {
        ...
        seoDescription: "The largest collection of Noteblock Studio songs (.nbs files) for use in NoteBlockAPI to play Note Block music in Minecraft."
    }, {
        path: "banner-creator",
        name: "Banner Creator",
        description: "Create a banner design and get in-game commands and code.",
        shortDescription: "Craft banners and get code",
        seoDescription: "Create Minecraft banners using a range of colors or patterns and receive the /give command and Spigot API code."
    }, {
        path: "daylight-cycle",
        name: "Daylight Cycle",
