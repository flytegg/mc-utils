const utils: Util[] = [
    {
        ...
        seoDescription: "Download Minecraft server jars of any version including Vanilla, CraftBukkit, Spigot, Paper, Purpur, Folia, BungeeCord, Waterfall and Velocity."
    },
    {
        path: "item-ids",
        name: "Item IDs",
