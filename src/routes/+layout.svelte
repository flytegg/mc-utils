...
<div class="flex lg:flex-row flex-col">
    ...
    <div class="flex flex-col w-full justify-between">
        <div class="flex flex-col w-full items-center">
            {#if showBanner}
                <a href="https://discord.gg/flyte" target="_blank" class="hidden py-1.5 w-full bg-[#5661f5] xl:flex justify-center items-center gap-1.5 text-lg text-white font-medium hover:underline">
                    Join our 
