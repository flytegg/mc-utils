        ...
        <div data-sveltekit-reload>
            {#if $Favourites.length > 0}
                <div class="flex flex-col space-y-2 mb-6">
                    <h2 class="text-[#626875] uppercase font-bold text-sm">Favourites</h2>
